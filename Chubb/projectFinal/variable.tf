...
# Input variable: nsxHost
variable "nsxHost" {
  description = "The NSX-T host IP"
  type = string
  default = ""
}

# Input variable: nsxUser
variable "nsxUser" {
  description = "The NSX-T host username"
  type = string
  default = ""
}

# Input variable: nsxPassword
variable "nsxPassword" {
  description = "The NSX-T host user password"
  type = string
  default = ""
}
